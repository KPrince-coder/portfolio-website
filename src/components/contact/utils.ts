 ...
 *
 * @example
 * splitTitle("Let's Connect")
 * // Returns: { title: "Let's", titleHighlight: "Connect" }
 *
 * splitTitle("Get In Touch")
 * // Returns: { title: "Get In", titleHighlight: "Touch" }
 *
 * splitTitle("Contact")
 * // Returns: { title: "Contact", titleHighlight: undefined }
 */
export function splitTitle(fullTitle: string): {
  ...
  if (!fullTitle || typeof fullTitle !== "string") {
    return { title: "Let's", titleHighlight: "Connect" };
  }
